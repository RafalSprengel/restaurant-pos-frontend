      ...
      <div className="home-page__section-1">
        <div className="home-page__section-1__content">
          ...
          <div className="home-page__section-1__content__buttons-wrap">
            <NavLink to="menu">
              {' '}
              <button className="home-page__section-1__content__button-order button-contained">ZAMÓW ONLINE</button>
            </NavLink>
            <NavLink to="menu">
              {' '}
              <button className="home-page__section-1__content__button-menu button-outlined">ZOBACZ MENU</button>
            </NavLink>
          </div>
        </div>
      </div>
