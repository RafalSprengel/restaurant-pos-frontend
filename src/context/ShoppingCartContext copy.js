...
export function ShoppingCartProvider({ children }) {
    ...
    const openDelAllConfirmModal = () => setIsConfirmModalOpen(true);

    const closeDelConfirmModal = () => setIsConfirmModalOpen(false);
    ...
    return (
        <ShoppingCartContext.Provider value={{
            ...
            <ConfirmationModal
                ...
                onConfirm={() => itemToRemove && removeProductFromCart(itemToRemove)}
            />
