                    ...
                    <div className="header__login-icon-wrap">
                         <div className="header__cart-wrap" onClick={() => openCart()}>
                              <div className="header__cart-wrap__inner" alt="Cart" title="Cart">
                                   ...
                                   {cartQuantity > 0 && <span className="header__cart-wrap__inner__number">{cartQuantity}</span>}
                              </div>
                         </div>
                         <div className="header__login-icon-wrap" alt="Login" title="Login" onClick={() => navigate('/customer/login')}>
