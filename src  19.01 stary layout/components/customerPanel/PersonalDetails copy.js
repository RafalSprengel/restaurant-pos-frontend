               ...
               <div className="personal-details__profile">
                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                         ...
                         <div className="form-group">
                              ...
                              {isEditingProfile ? (
                                   <input type="text" id="phone" name="phone" value={details.phone} onChange={handleInputChange} />
                              ) : (
                                   <p>{details.phone}</p>
                              )}
                         </div>
               ...
               <div className="personal-details__address">
                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                         ...
                         <div className="form-group">
                              ...
                              {isEditingAddress ? (
                                   <input type="text" id="city" name="city" value={details.city} onChange={handleInputChange} />
                              ) : (
                                   <p>{details.city}</p>
                              )}
                         </div>
